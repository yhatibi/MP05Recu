...
//                temp = temp.next;
            ...
            //mientras temp no sea null voy aplicando el next y comprobando si son iguales, si lo son salgo del bucle y se lo asigno al newEntries con otro bracket para que no colisione
            while (temp.next != null) {
                if (temp.key.equals(key)) {
                    temp.value = value;
                    return;
    ...
    //metodo para asignar nuevo entry al key con colison
